...
3. КРИТЕРИИ ОЦЕНИВАНИЯ ДАННОГО ЗАДАНИЯ:
    ...
    5) за шаблон презентации данных Model - View (конструктор модели реализован как QList<QList<QVariant> >&) вы получаете ещё x баллов
    ...
    7) за использование класса logger (как в задании https://github.com/mgordenko/course_c_plus_23_24/tree/main/2023_2024_2nd_sem/week11/sem_22) вы получаете ещё x баллов
